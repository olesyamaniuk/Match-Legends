document.addEventListener("DOMContentLoaded", () => {
  ...
  const navListRef = document.querySelector(".o-navigation-list");
  const headerRef = document.querySelector(".o-header");
  const navigationRef = document.querySelector(".o-navigation");
...
function toggleAnswer(element) {
  ...
  const buttonImg = element.querySelector(".o-toggle-button img");
